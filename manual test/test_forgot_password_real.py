#!/usr/bin/env python3
"""
Test Forgot Password functionality with real email
"""
...
ORIGINAL_PASSWORD = "Prince@123"
NEW_PASSWORD = "Prince@456"

def get_latest_otp(email, otp_type='password_reset'):
...
def test_get_password_reset_otp():
    ...
    otp_code, otp_time = get_latest_otp(REAL_EMAIL, 'password_reset')
...
def test_password_reset_confirm(reset_otp):
    """Test password reset confirmation"""
    print("\n🔐 Step 3: Testing Password Reset Confirmation")
    print("=" * 50)
...
def test_login_with_old_password():
    ...
    try:
        ...
        if response.status_code in [400, 401]:
            ...
            print(f"⚠️ Unexpected: Login with old password succeeded: {response.text}")
            return False
...
def main():
    """Run complete forgot password test"""
    print("🚀 Forgot Password Flow Test with Real Email")
    print("=" * 60)
    ...
    results['request'] = test_forgot_password_request()
    ...
    results['confirm'] = test_password_reset_confirm(reset_otp)
    ...
    if all_passed:
        ...
        print("🚀 Forgot password functionality is working perfectly!")
